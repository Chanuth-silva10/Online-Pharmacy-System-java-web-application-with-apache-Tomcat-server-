...
%>	 
		...
		<div class="row12">
		    ...
		    <div class="column12" >
                 ...
                 <input type="text"  name="pName" value="<%=rs.getString(2)%>"  id="email" readonly>
		    </div>
		</div>
        <div class="row12">
		    <div class="column12" >
		         <label for="email"><b>Category</b></label>
                 <input type="text"  name="pCategory" value="<%=rs.getString(3)%>"  id="email" readonly>
		    </div>
		    <div class="column12" >
		         <label for="email"><b>Price</b></label>
                 <input type="text"  name="pPrice" value="<%=rs.getDouble(4)  %>" id="email" readonly>
		    </div>
		</div>
        <div class="row12">
		    <div class="column12" >
		         <label for="email"><b>Status</b></label>
                 <input type="text" placeholder="Status" value="<%=rs.getString(5)%>"  name="pStatus" id="email" readonly>
		    </div>
		    <div class="column12" >
		         <label for="email"><b>AddImage</b></label>
                 <input type="text" placeholder="AddImage" value="<%=rs.getString(6)%>"  name="pImage" id="email" readonly>
		    </div>
		     <input type="submit" id="email" value="RemoveProduct" >
		</div>
